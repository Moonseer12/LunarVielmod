...
namespace Stellamod.Content.Areas.Tundra.MoonspiralTower.BossesMT.VerliaBoss.Projectiles;
...
public class VerliaBouncingMoonShockwave : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        if (Style == 1)
        {
            ...
            string path = $"Stellamod/Content/Areas/MoonspiralTower/BossesMT/VerliaBoss/VerlianSigil";
