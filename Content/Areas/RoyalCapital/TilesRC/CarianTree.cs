...
namespace Stellamod.Content.Areas.RoyalCapital.TilesRC
{
    class CarianTree : ModTree
    {
        ...
        public override Asset<Texture2D> GetTexture() => ModContent.Request<Texture2D>("Stellamod/Content/Areas/RoyalCapital/TilesRC/CarianTree");
        public override Asset<Texture2D> GetTopTextures() => ModContent.Request<Texture2D>("Stellamod/Content/Areas/RoyalCapital/TilesRC/CarianTree_Top");
        public override Asset<Texture2D> GetBranchTextures() => ModContent.Request<Texture2D>("Stellamod/Content/Areas/RoyalCapital/TilesRC/CarianTree_Branches");
