...
namespace Stellamod.Content.Areas.RoyalCapital.BossesRC.STARBOMBER
{
    public class STARBOMBERGUN
    {
        ...
        public void Prime()
        {
            ...
            var part = GlowDonutParticle.Spawn(_lastPosition, Vector2.Zero, Color.White);
            part.Scale *= 4;
            part.shrink = true;
            part.noStretch = true;
        }
        public void Prime2(Vector2 muzzlePoint)
        {
            ...
            var part = GlowDonutParticle.Spawn(muzzlePoint, Vector2.Zero, Color.White);
            part.Scale *= 4;
            part.shrink = true;
            part.noStretch = true;
        }
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 position, Vector2 direction, Color lightColor)
        {
            ...
            SpritebatchDrawer glowDrawer = SpritebatchDrawer.FromTextureAsset(ModContent.Request<Texture2D>("Stellamod/Assets/GlowMasks/SimpleGlowCircle"), 
            ...
            Vector2 lineOrigin = new(aimingLine.Size().X / 2f, 0f);
            Vector2 lineScale = new(0.01f, 1f);
