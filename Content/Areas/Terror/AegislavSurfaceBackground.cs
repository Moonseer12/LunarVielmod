...
public partial class AegislavSurfaceBackground : CustomBG
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        _farTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "AegislavSurface_Far");
        _midTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "AegislavSurface_Mid");
        _closeTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "AegislavSurface_Close");
        _undergroundTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "AegislavSurface_UndergroundLoop");
    }
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        Color fadeToColor = new(124, 87, 94);
        fadeToColor *= 0.96f;
