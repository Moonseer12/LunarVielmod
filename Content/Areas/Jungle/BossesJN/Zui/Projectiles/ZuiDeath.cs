            ...
            if (DM)
            {
                ...
                if (NPC.ai[2] == 10)
                {
                    ...
                    if (NPC.ai[0] == 110)
                    {
                        ...
                        for (int i = 0; i < 14; i++)
                        {
                            Dust.NewDustPerfect(base.NPC.Center, DustID.Torch, (Vector2.One * Main.rand.Next(1, 12)).RotatedByRandom(19.0), 0, default, 4f).noGravity = false;
                        }
                        for (int i = 0; i < 14; i++)
                        {
                            Dust.NewDustPerfect(base.NPC.Center, DustID.GoldFlame, (Vector2.One * Main.rand.Next(1, 12)).RotatedByRandom(19.0), 0, default, 4f).noGravity = false;
                        }
                        for (int j = 0; j < 26; j++)
                        {
                        ...
                        for (int i = 0; i < 40; i++)
                        {
                            Dust.NewDustPerfect(base.NPC.Center, DustID.GoldFlame, (Vector2.One * Main.rand.Next(1, 12)).RotatedByRandom(10.0), 0, default, 1f).noGravity = false;
                        }
