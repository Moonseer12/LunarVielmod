...
{
    public class SilverBell1Item : DecorativeWallItem
    {
    ...
    public class SilverBell2Item : DecorativeWallItem
    {
        public override void SetDefaults()
        {
            base.SetDefaults();
    ...
    public class SilverBell3Item : DecorativeWallItem
    {
        public override void SetDefaults()
        {
            base.SetDefaults();
    ...
    public class RoundBell2Item : DecorativeWallItem
    {
        public override void SetDefaults()
        {
            base.SetDefaults();
    ...
    public class BellSigil4Item : DecorativeWallItem
    {
        public override void SetDefaults()
        {
            base.SetDefaults();
