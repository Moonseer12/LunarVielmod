...
namespace Stellamod.Content.Areas.Snow
{
    ...
    public class IceLakeBG : CustomBG
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            //Guh
            CustomBGLayer backFogLayer = new();
            backFogLayer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceGradient");
            backFogLayer.Parallax = startParallax;
            backFogLayer.DrawOffset = Vector2.Zero;

            MistShader mistShader = new();
            ...
            back2Layer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceBack2");
            ...
            midLayer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceMiddle");
            midLayer.Parallax = startParallax + 0.02f;
            midLayer.DrawOffset = Vector2.Zero;
            AddLayer(midLayer);

            CustomBGLayer midFogLayer = new();
            midFogLayer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceGradient");
            ...
            frontLayer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceFront");
            frontLayer.Parallax = startParallax + 0.05f;
            frontLayer.DrawOffset = Vector2.Zero;
            AddLayer(frontLayer);

            front2Layer = new CustomBGLayer();
            front2Layer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceFront2");
            ...
            bleedLayer.SetTexture(AssetRegistry.Textures.BackgroundPath + "IceUnderground");
