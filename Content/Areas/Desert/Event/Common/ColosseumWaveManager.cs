        ...
        public static Vector2 GongSpawnWorld
        {
            get
            {
                if (_colosseumRectangle == Rectangle.Empty)
                    _colosseumRectangle = Structurizer.ReadRectangle("Structures/Colosseum/TheColosseum");
                NPCPointSpawnSystem npcPointSpawnSystem = ModContent.GetInstance<NPCPointSpawnSystem>();
                Point colosseumOriginTile = npcPointSpawnSystem.GetStructureTile("Structures/Colosseum/TheColosseum");
