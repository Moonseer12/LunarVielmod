...
public class WorldsEndBG : CustomBG
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        _farTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "GreyGrassBackgroundFar");
        _midTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "GreyGrassBackgroundMid");
        _closeTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "GreyGrassBackgroundClose");
        _undergroundTextureAsset = ModContent.Request<Texture2D>(AssetRegistry.Textures.BackgroundPath2 + "GreyGrassBackgroundUndergroundLoop");
    }
