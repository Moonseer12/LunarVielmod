...
namespace Stellamod.Content.Areas.PunkerTown.BossesPT.IrradiaNHavoc.Havoc
{
    ...
    public class Havoc : ModNPC
    {
        ...
        //Textures
        public const string BaseTexturePath = "Stellamod/Content/Areas/PunkerTown/BossesPT/IrradiaNHavoc/Havoc/";
        ...
        public override void AI()
        {
            ...
            if (ArenaCenter == default && MultiplayerHelper.IsHost)
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            {
                Texture2D warningTexture = ModContent.Request<Texture2D>("Stellamod/Content/Areas/PunkerTown/BossesPT/IrradiaNHavoc/Havoc/Projectiles/HavocWarnChargeProj").Value;
                Player target = Main.player[NPC.target];
