...
{
    public class GlowCircleLongBoomParticle : Particle<GlowCircleLongBoomParticle>
    {
        public float Timer;
    ...
    public class GlowCircleDetailedBoomParticle1 : Particle<GlowCircleDetailedBoomParticle1>
    {
        public float Timer;
        public float Duration;
        public float Progress;
    ...
    public class GlowCircleBoomParticle : Particle<GlowCircleBoomParticle>
    {
        public float Timer;
        public float Duration;
        public float Progress;
