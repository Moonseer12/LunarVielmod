...
namespace Stellamod.Content.Special.EckasectSire
{
    ...
    public class EckasectSire : ModItem
    {
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            if (!player.HasBuff<Genesis>() && !player.HasBuff<Liberator>() && !player.HasBuff<Executor>())
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Stellamod/Content/Special/EckasectSire/EckasectSire").Value;
            ...
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Stellamod/Content/Special/EckasectSire/EckasectLiber").Value;
                spriteBatch.Draw(iconTexture, position, null, drawColor, 0f, origin, scale, SpriteEffects.None, 0);
                return false;
            }
            ...
            {
                Texture2D iconTexture = ModContent.Request<Texture2D>("Stellamod/Content/Special/EckasectSire/EckasectExe").Value;
                spriteBatch.Draw(iconTexture, position, null, drawColor, 0f, origin, scale, SpriteEffects.None, 0);
                return false;
            }
