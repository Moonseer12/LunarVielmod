    ...
    public abstract class MiniGun : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (IsSpecial)
            {
                ...
                line = new(Mod, "LeftHanded", "Equip to your gun holster's or scorpion's left hand!");
                line.OverrideColor = tooltipColor;
                tooltips.Add(line);
                line = new(Mod, "RightHanded", "OR equip to your gun holster's or scorpion's right hand!");
                line.OverrideColor = tooltipColor;
                tooltips.Add(line);
                if (TwoHands)
                {
                    line = new(Mod, "BothHanded", "Can be in both hands at the same time for both your scorpion and gun holster!");
                    line.OverrideColor = tooltipColor;
                    tooltips.Add(line);
                }
            }
            else
            {
                ...
                if (LeftHand)
                {
                    line = new(Mod, "LeftHanded", "Equip to your gun holsters' or scorpions' left hand!");
                    line.OverrideColor = tooltipColor;
                    tooltips.Add(line);
                }
                if (RightHand)
                {
                    line = new(Mod, "RightHanded", "Equip to your gun holsters' or scorpions' right hand!");
                    line.OverrideColor = tooltipColor;
                    tooltips.Add(line);
                }
            }
        ...
        public override void PostDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            const string Base_Path = "Stellamod/Content/GunSwapping/";
