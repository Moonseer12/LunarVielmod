...
namespace Stellamod
{
    public class Stellamod : Mod
    {
        ...
        public override void Load()
        {
            ...
            {
                string resprites = "Stellamod/Assets/Textures/Resprites/";
                TextureAssets.Tile[TileID.Dirt] = ModContent.Request<Texture2D>(resprites + "DirtRE");
                TextureAssets.Tile[TileID.IceBlock] = ModContent.Request<Texture2D>(resprites + "IceRE");
                TextureAssets.Tile[TileID.SnowBlock] = ModContent.Request<Texture2D>(resprites + "SnowRE");
                TextureAssets.Wall[WallID.Dirt] = ModContent.Request<Texture2D>(resprites + "DirtWallRE");
                TextureAssets.Tile[TileID.Stone] = ModContent.Request<Texture2D>(resprites + "StoneRE");
                TextureAssets.Tile[TileID.Grass] = ModContent.Request<Texture2D>(resprites + "GrassRE");
                TextureAssets.Tile[TileID.ClayBlock] = ModContent.Request<Texture2D>(resprites + "ClayRE");
                TextureAssets.Tile[TileID.Sand] = ModContent.Request<Texture2D>(resprites + "SandRE");
                TextureAssets.Tile[TileID.HardenedSand] = ModContent.Request<Texture2D>(resprites + "HardSandRE");
                TextureAssets.Tile[TileID.Sandstone] = ModContent.Request<Texture2D>(resprites + "StoneSandRE");
                TextureAssets.Tile[TileID.Mud] = ModContent.Request<Texture2D>(resprites + "MudRE");
                TextureAssets.Tile[TileID.CrimsonGrass] = ModContent.Request<Texture2D>(resprites + "CrimGrassRE");
                TextureAssets.Tile[TileID.JungleGrass] = ModContent.Request<Texture2D>(resprites + "MudGrassRE");
                TextureAssets.Tile[TileID.CorruptGrass] = ModContent.Request<Texture2D>(resprites + "CrorpGrassRE");
                TextureAssets.Tile[TileID.Crimstone] = ModContent.Request<Texture2D>(resprites + "CrimStoneRE");
                TextureAssets.Tile[TileID.WoodBlock] = ModContent.Request<Texture2D>(resprites + "WoodRE");
                TextureAssets.Tile[TileID.GrayBrick] = ModContent.Request<Texture2D>(resprites + "StoneBrickRE");
                TextureAssets.Tile[TileID.Pearlstone] = ModContent.Request<Texture2D>(resprites + "PearlstoneRE");
                TextureAssets.Tile[TileID.Granite] = ModContent.Request<Texture2D>(resprites + "GraniteRE");
                TextureAssets.Tile[TileID.Marble] = ModContent.Request<Texture2D>(resprites + "MarbRE");
                TextureAssets.Tile[TileID.MushroomGrass] = ModContent.Request<Texture2D>(resprites + "MushGrassRE");
                TextureAssets.Tile[TileID.Ebonstone] = ModContent.Request<Texture2D>(resprites + "CrorpStoneRE");
                TextureAssets.Tile[TileID.Ash] = ModContent.Request<Texture2D>(resprites + "AshingRE");
                TextureAssets.Tile[TileID.ObsidianBrick] = ModContent.Request<Texture2D>(resprites + "AshedRE");
                TextureAssets.Tile[TileID.Cloud] = ModContent.Request<Texture2D>(resprites + "CloudRE");
                TextureAssets.Tile[TileID.Pearlsand] = ModContent.Request<Texture2D>(resprites + "PearlSandRE");
                TextureAssets.Tile[TileID.SnowCloud] = ModContent.Request<Texture2D>(resprites + "SnowCloudRE");
            }
